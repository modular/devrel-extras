...
- [MAX examples](https://github.com/modular/modular/tree/main/max/examples)
- [MAX agentic cookbook](https://github.com/modular/max-agentic-cookbook)
- [LLM inference](https://llm.modular.com/)
